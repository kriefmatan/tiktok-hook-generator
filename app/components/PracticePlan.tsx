...
function PracticeSection({ title, block }: { title: string; block: PracticeBlock }) {
  ...
  return (
    <section className="break-inside-avoid rounded-lg border border-zinc-800 bg-zinc-900/50 px-5 py-4">
      ...
      <div className="mt-4 rounded-md border border-zinc-700/80 bg-black/35 p-3">
        <p className="text-[10px] font-semibold uppercase tracking-wide text-zinc-500">Half court</p>
        <HalfCourtDiagram
        ...
        <p className="mt-2 text-[10px] leading-relaxed text-zinc-500">
          Blue = offense · Red = defense · Solid = movement · Dashed = pass
        </p>
      </div>
